...
vortex at \red{$(t-t_0)/\tau_R=8.79\times10^{-4}$} . In the bottom sequence, the red/blue volume
...
triggers the inverse energy cascade which is observed numerically} \CHANGE{in  
