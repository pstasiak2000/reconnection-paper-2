...
\begin{abstract}
Vortex reconnections play a fundamental role in fluids and they are typically considered as a mechanism to increase the complexity of classical flows and trigger their small scales. In this work, we show that in superfluids, they can also create large scale structures.
...
We now focus on the time evolution of the normal fluid energy spectrum $E(k)$ (where $k$ is the magnitude of the three-dimensional wavenumber), illustrated in Fig.~\ref{fig:kinetic-energy}.a. 
\begin{figure}[b]
    \centering
...
in Fig.~\ref{fig:visualisation}} \NOTE{GK: the figure show small scale structures...}
