...
is injected 
into the thermal (normal) component of helium~II at small length scales, but is transferred nonlinearly  to larger length scales, 
increasing the integral length scale of the normal fluid.  
...
observe a strong non-classical effect. The results presented hence contribute to 
